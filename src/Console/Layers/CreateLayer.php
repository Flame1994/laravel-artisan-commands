...
namespace Rhaarhoff\LaravelArtisanCommands\Console\Layers;

use Illuminate\Support\Str;
use Illuminate\Console\GeneratorCommand;
use Symfony\Component\Console\Input\InputOption;

class CreateLayer extends GeneratorCommand
{
    /**
    ...
    public function handle()
    {
        ...
        if ($this->option('service')) {
            if ($this->option('repository')) {
                $this->createServiceAndRepository();
            } else {
                $this->createService();
            }
        }
    ...
    /**
     * Create a repository & service for the model.
     *
     * @return void
     */
    protected function createServiceAndRepository()
    {
        $repo = Str::studly(class_basename($this->argument('name')));
